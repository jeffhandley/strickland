import {every, required, minLength, maxLength, withMiddleware} from '../src/strickland';
...
describe('every', () => {
    ...
    describe('supports middleware', () => {
        ...
        it('using a withMiddleware wrapper', () => {
            ...
            const validate = every([required()], {prop: 'propValue'});
            ...
            const result = validateWithMiddleware(null);
